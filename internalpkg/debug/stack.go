...
var stackSkip = [][]byte{
	...
	// api/stack.go
	[]byte("github.com/xaionaro-go/go2rtc/internalpkg/api.stackHandler"),

	// api/api.go
	[]byte("created by github.com/xaionaro-go/go2rtc/internalpkg/api.Init"),
	[]byte("created by net/http.(*connReader).startBackgroundRead"),
	[]byte("created by net/http.(*Server).Serve"), // TODO: why two?

	[]byte("created by github.com/xaionaro-go/go2rtc/internalpkg/rtsp.Init"),
	[]byte("created by github.com/xaionaro-go/go2rtc/internalpkg/srtp.Init"),

	// homekit
	[]byte("created by github.com/xaionaro-go/go2rtc/internalpkg/homekit.Init"),
