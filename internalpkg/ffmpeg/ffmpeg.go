...
import (
	...
	"github.com/xaionaro-go/go2rtc/internalpkg/ffmpeg/device"
	"github.com/xaionaro-go/go2rtc/internalpkg/ffmpeg/hardware"
	"github.com/xaionaro-go/go2rtc/internalpkg/ffmpeg/virtual"
	...
	"github.com/xaionaro-go/go2rtc/pkg/ffmpeg"
...
var defaults = map[string]string{
	...
	// hardware Rockchip
	// important to use custom ffmpeg https://github.com/xaionaro-go/go2rtc/issues/768
...
func parseArgs(s string) *ffmpeg.Args {
	...
	if query != nil {
		...
		for _, raw := range query["raw"] {
			// support templates https://github.com/xaionaro-go/go2rtc/issues/487
