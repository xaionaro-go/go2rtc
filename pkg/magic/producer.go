...
import (
	...
	"github.com/xaionaro-go/go2rtc/pkg/magic/bitstream"
	"github.com/xaionaro-go/go2rtc/pkg/magic/mjpeg"
	"github.com/xaionaro-go/go2rtc/pkg/mpegts"
	"github.com/xaionaro-go/go2rtc/pkg/mpjpeg"
	"github.com/xaionaro-go/go2rtc/pkg/wav"
...
func Open(r io.Reader) (core.Producer, error) {
	...
	// https://github.com/xaionaro-go/go2rtc/issues/747
